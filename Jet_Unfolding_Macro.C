...
)
{
   ...
   Int_t NBins = 0;
   Double_t* BinEdgesPi0 = new Double_t[200];
   Double_t* BinEdgesEta = new Double_t[200];
   Int_t MaxBinPi0 = GetBinning( BinEdgesPi0, NBins, "Pi0", Energy, Mode, -1, kFALSE, "", kTRUE );
   Int_t MaxBinEta = GetBinning( BinEdgesEta, NBins, "Eta", Energy, Mode, -1, kFALSE, "", kTRUE );
   ...
   T1.DrawLatex(0.3, 0.80, "pp, #sqrt{S_{NN}} = 5 TeV");
   ...
   T2.DrawLatex(0.3, 0.80, "pp, #sqrt{S_{NN}} = 5 TeV");
